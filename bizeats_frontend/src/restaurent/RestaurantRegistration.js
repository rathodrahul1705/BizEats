...
import { ArrowRight, Utensils, ClipboardList, FileCheck, CreditCard, FileSignature, CheckCircle, Image, Clock } from "lucide-react";
    ...
    <div className="registration-container">
      ...
      <div className="form-container">
          ...
          <div className="info-section">
            ...
            <div className="info-card">
              ...
              <div className="input-group">
                <input type="text" placeholder="Restaurant Name (Customers will see this name on Zomato)" />
              </div>
            </div>
            ...
            <div className="info-card">
              ...
              <div className="input-group">
                ...
                <input type="text" placeholder="Restaurant's Primary Contact Number" />
              </div>
            </div>
            ...
            <div className="info-card">
              ...
              <div className="input-group">
                ...
                <input type="text" placeholder="Add Any Nearby Locality" />
              </div>
            </div>
          </div>
        )}
        ...
        <div className="form-navigation">
          {step > 1 && <button className="prev-btn" onClick={prevStep}>Back</button>}
          {step < steps.length ? (
